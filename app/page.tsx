	  ...
	  {[
		...
		>
		  <svg width="13" height="14" viewBox="0 0 13 14" fill="none">
			...
			/>
			<path d="M9 1v3h3" stroke="#2D6A56" strokeWidth="1.2" fill="none" />
			<path
			  d="M4 7h5M4 9.5h3.5"
			  stroke="#9DDECE"
			  strokeWidth="1"
...
function SummaryPreview() {
  return (
	...
	>
	  {["Introduction & Background", "Key Findings", "Recommendations"].map(
		(item, i) => (
		  <div
			key={i}
			style={{
		  ...
		  >
			...
			/>
			<span style={{ fontSize: 10, color: "#9CA3AF" }}>{item}</span>
		  </div>
		),
	  )}
	</div>
	...
	icon: (
	  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
		<path
		  ...
		  strokeLinejoin="round"
		/>
		<path d="M12 2v4h4" stroke="#2D6A56" strokeWidth="1.4" fill="none" />
		<path
		  d="M6 10h6M6 12.5h4"
		  stroke="#9DDECE"
		  strokeWidth="1.2"
		...
		>
		  ...
		  >
			...
			>
			  ...
			  <span style={{ color: "#2D6A56" }}>Simplified.</span>{" "}
			...
			>
			  Smart, instant, 24/7 AI to extract insights and answers from your
			  documents
			</p>
		  ...
		  <div style={{ animation: "fadeUp 0.6s ease 0.2s both" }}>
			<Card style={{ padding: "16px 18px" }}>
			  ...
			  >
				"Tried many, but Documind stands out! Our team saves hours every
				week." 🔥
			  </p>
			</Card>
		  </div>
