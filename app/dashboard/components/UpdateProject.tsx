		...
		<DialogContent className="sm:max-w-md">
		  <form onSubmit={handleSubmit}>
			<DialogHeader>
			  ...
			  <DialogDescription>
				Interact with your documents using AI. Upload your documents and
			...
			<FieldGroup className="py-6 space-y-0">
			  ...
			  <Field>
				<Label htmlFor="docs">Upload Documents (1-3 PDFs) *</Label>
				<Input
				  id="docs"
				  type="file"
				  accept=".pdf"
				  multiple
				  required={!existingDocs || existingDocs.length === 0}
			  ...
			  <div className="grid grid-cols-2 gap-4 pt-2">
				<Field>
				  ...
				  <Select
					...
					onValueChange={(val) =>
					  setProjectCategory(val as ProjectCategoryType)
					}
				  >
					<SelectTrigger>
	  ...
	  <Dialog open={openDelete} onOpenChange={setOpenDelete}>
		<DialogContent>
		  <DialogHeader>
			...
			<DialogDescription>
			  This will permanently delete the project and associated documents.
		  ...
		  <DialogFooter>
			...
			>
			  {isSubmitting ? "Deleting Project..." : "Yes, Delete permanently"}
			</Button>
		  </DialogFooter>
		</DialogContent>
	  </Dialog>
